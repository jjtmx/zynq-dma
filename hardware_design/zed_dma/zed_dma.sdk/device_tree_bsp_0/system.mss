...
BEGIN OS
 ...
 PARAMETER bootargs = console=ttyPS0,115200 root=/dev/ram rw cma=25M earlyprintk
...
BEGIN DRIVER
 ...
 PARAMETER interrupts = 0 31 4 0 30 4
...
BEGIN DRIVER
 ...
 PARAMETER xlnx,gpio-width = 3
 PARAMETER xlnx,gpio2-width = 5
