...
#
# Generated by export_simulation on Wed Apr 19 20:16:15 +0800 2017
#
################################################################################
...
switch to the './ila_int.sh' script.

./ila_int.sh -reset_run
...
./ila_int.sh -noclean_files

For more information on the script, please type './ila_int.sh -help'.
