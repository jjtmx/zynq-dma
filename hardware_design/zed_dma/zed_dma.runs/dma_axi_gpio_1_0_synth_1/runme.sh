...
HD_PWD='/home/gsc/zynq7000/projects/hardware_design/zed_dma/zed_dma.runs/dma_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axi_gpio_1_0.tcl
