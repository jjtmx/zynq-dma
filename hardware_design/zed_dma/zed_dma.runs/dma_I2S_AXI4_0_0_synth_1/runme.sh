...
HD_PWD='/home/gsc/zynq7000/projects/hardware_design/zed_dma/zed_dma.runs/dma_I2S_AXI4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_I2S_AXI4_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_I2S_AXI4_0_0.tcl
