...
proc create_root_design { parentCell } {
  ...
  set btn5 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 btn5 ]
  set leds8 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 leds8 ]

  # Create ports
  set axi_resetn [ create_bd_port -dir I -type rst axi_resetn ]

  # Create instance: I2S_AXI4_0, and set properties
  set I2S_AXI4_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:I2S_AXI4:1.0 I2S_AXI4_0 ]
...
CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {24.000000} \
...
CONFIG.NUM_PORTS {3} \
  ...
  connect_bd_intf_net -intf_net I2S_AXI4_0_s2mm [get_bd_intf_pins I2S_AXI4_0/s2mm] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports btn5] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports leds8] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_net -net axi_resetn_1 [get_bd_ports axi_resetn] [get_bd_pins axi_dma_0/axi_resetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins I2S_AXI4_0/axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins I2S_AXI4_0/axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
preplace port btn5 -pg 1 -y 370 -defaultsOSRD
preplace port axi_resetn -pg 1 -y 250 -defaultsOSRD
preplace port leds8 -pg 1 -y 500 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 90 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 3 -y 210 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 360 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 5 -y 380 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 5 -y 500 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 330 -defaultsOSRD
preplace inst I2S_AXI4_0 -pg 1 -lvl 2 -y 90 -defaultsOSRD
...
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 3 700J 480 NJ 480 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 400 -50 NJ -50 NJ -50 NJ -50 1920
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 370 520 NJ 520 1120 520 1460
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 -30 NJ -30 NJ -30 NJ -30 NJ -30 1930
...
preplace netloc axi_gpio_0_ip2intc_irpt 1 3 3 1140 280 1440J 300 1910
preplace netloc axi_resetn_1 1 0 3 30J 490 NJ 490 720J
preplace netloc I2S_AXI4_0_s2mm 1 2 1 710
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 -20 380 -20 720 -20 1110 -20 1450 -20 1910
preplace netloc axi_gpio_1_GPIO 1 5 1 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 3 690J 320 1130J 290 1430
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 3 390 150 700J 100 N
levelinfo -pg 1 0 200 550 920 1280 1690 1950 -top -70 -bot 570
",
}
