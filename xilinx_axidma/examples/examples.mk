...
EXAMPLES_FILES = axidma_benchmark.c axidma_display_image.c axidma_transfer.c axidma_rokid.c rokid_npu.c
...
EXAMPLES_LIB_FLAGS = -L /home/gsc/zynq7000/projects/xilinx_axidma/library -l $(LIBAXIDMA_NAME) \
...
$(EXAMPLES_EXECUTABLES): $$@.c $(UTIL) | $(LIBAXIDMA_OUTPUT_LIBRARY) \
	...
	$(CC) $(EXAMPLES_CFLAGS) -static $(LIBAXIDMA_INC_FLAGS) $(filter %.c,$^) -o $@ $(EXAMPLES_LIB_FLAGS)
