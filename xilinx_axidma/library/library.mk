...
LIBAXIDMA_LIBRARY_INTE = $(LIBAXIDMA_DIR)/lib$(LIBAXIDMA_NAME).o
LIBAXIDMA_LIBRARY_STATIC = $(LIBAXIDMA_DIR)/lib$(LIBAXIDMA_NAME).a
LIBAXIDMA_OUTPUT_LIBRARY = $(OUTPUT_DIR)/lib$(LIBAXIDMA_NAME).so $(OUTPUT_DIR)/lib$(LIBAXIDMA_NAME).a
...
library: $(LIBAXIDMA_LIBRARY_INTE) $(LIBAXIDMA_OUTPUT_LIBRARY) 
...
$(LIBAXIDMA_LIBRARY_INTE): $(LIBAXIDMA) $(LIBAXIDMA_INC) | cross_compiler_check
	$(CC) $(LIBAXIDMA_INC_FLAGS) $(filter %.c,$^) -c 

$(LIBAXIDMA_LIBRARY_STATIC): $(LIBAXIDMA) $(LIBAXIDMA_INC) | cross_compiler_check
	$(AR) -rcs $@ $(LIBAXIDMA_LIBRARY_INTE) 

# Copy the compiled shared library object to the specified output directory
$(LIBAXIDMA_OUTPUT_LIBRARY): $(LIBAXIDMA_LIBRARY) $(OUTPUT_DIR) $(LIBAXIDMA_LIBRARY_STATIC)
	@cp $< $@
